...
# Now we will plot the location of each metro station and each bikeshare dock using the OpenStreetMap package. First, we will plot it without a background.
```{r}
...
```{r}
tmap_mode("view")
tm_shape(points) + tm_dots("loc_type")
```
